...
export default function ClientePedidoScreen() {
  ...
  const cargarCliente = async () => {
    const tokenCliente = await obtenerDato('token_cliente');
    const clienteGuardado = await obtenerDato('cliente');

    if (tokenCliente && clienteGuardado) {
      ...
      Alert.alert(
        'Sesión requerida',
        'Debe iniciar sesión o registrarse para realizar un pedido'
      );
  ...
  const confirmarPedido = async () => {
    ...
    if (!tokenCliente || !clienteGuardado || !cliente) {
      Alert.alert(
        'Sesión requerida',
        'Debe iniciar sesión o registrarse para realizar un pedido'
      );
