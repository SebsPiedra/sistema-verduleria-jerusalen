...
export default function VentasScreen() {
  ...
  const registrarVenta = async () => {
    ...
    try {
      ...
      setFacturaGenerada({
        ...respuesta.data,
        fecha_registro_visual: obtenerFechaActual(),
      });
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.fechaBox}>
        <Text style={styles.fechaTitulo}>Fecha de registro</Text>
        <Text style={styles.fechaTexto}>{obtenerFechaActual()}</Text>
      </View>
      ...
      {facturaGenerada && (
        <View style={styles.facturaBox}>
          ...
          <Text style={styles.facturaTexto}>
            Fecha: {facturaGenerada.fecha_venta
              ? formatearFecha(facturaGenerada.fecha_venta)
              : facturaGenerada.fecha_registro_visual}
          </Text>
